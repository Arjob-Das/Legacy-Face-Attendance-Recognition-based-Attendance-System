"""
Image Uploader & Encoder (Teachers).

Reads images from ImagesT/, resizes them to 216x216, uploads to Firebase Storage,
generates face encodings, and saves to EncodeFileT.p.
"""
...
# ── Firebase ────────────────────────────────────────────────────────
_, bucket = initialize_firebase(include_storage=True, is_teacher=True)
...
for path in pathList:
    ...
    teachids.append(os.path.splitext(path)[0])
...
with open("EncodeFileT.p", 'wb') as f:
